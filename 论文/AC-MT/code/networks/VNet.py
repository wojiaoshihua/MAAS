...
class Decoder(nn.Module):
    ...
    def forward(self, features):
        ...
        x5_up = x5_up + x4
        #torch.zeros([2, 2, 112, 112, 80]).cuda()
        #print("1")
...
class VNet(nn.Module):
    ...
    def forward(self, input):
        ...
        out_tanh, out_seg, x8_conf, x7_conf, x6_conf, x5_conf = self.decoder1(features)
        return out_tanh, out_seg, x8_conf, x7_conf, x6_conf, x5_conf
...
class MCNet3d_v2(nn.Module):
    ...
    def forward(self, input):
        ...
        return out_seg1, out_seg2, out_seg3, out_dis1, out_dis2, out_dis3
