...
parser.add_argument('--exp', type=str,
                    default='BraTs2019_UGMCL_25', help='experiment_name')
...
def Inference(FLAGS):
    ...
    num_classes = 2
    test_save_path = "../model/BraTs2019_UGMCL_25/{}_Inference".format(
        FLAGS.model)
    ...
    net.eval()
    avg_metric = test_all_case(net, base_dir=FLAGS.root_path, method=FLAGS.model, test_list="inference25UGMCL.txt", num_classes=num_classes,
