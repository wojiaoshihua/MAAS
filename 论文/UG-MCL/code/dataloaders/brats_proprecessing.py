...
all_flair = glob.glob("/home/zhangmingxiu/dataset/BraTS2019/MICCAI_BraTS_2019_Data_Training/*/*_flair.nii.gz")
for p in all_flair:
    ...
    sitk.WriteImage(sitk.GetImageFromArray(
        img), "/home/zhangmingxiu/dataset/BraTS2019/MICCAI_BraTS_2019_Data_Training/flair/{}".format(uid))
    sitk.WriteImage(sitk.GetImageFromArray(
        lab), "/home/zhangmingxiu/dataset/BraTS2019/MICCAI_BraTS_2019_Data_Training/label/{}".format(uid))
