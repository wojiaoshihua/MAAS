...
parser.add_argument('--root_path', type=str, default='/home/zhangmingxiu/dataset', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='mcnet3d_v2', help='exp_name')
...
def test_calculate_metric():
    ...
    net = net_factory(net_type='mcnet3d_v2', in_chns=1, class_num=num_classes, mode="test")
    save_mode_path = "/home/zhangmingxiu/MC-Net-main/model/LA_MCNet_8_labeled/mcnet3d_v2/base/iter_13000_dice_0.9053895372231718.pth"
