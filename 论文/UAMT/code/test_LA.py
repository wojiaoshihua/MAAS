...
parser.add_argument('--model', type=str,  default='MT_unlabel16', help='model_name')
...
def test_calculate_metric(epoch_num):
    ...
    save_mode_path = "/home/zhangmingxiu/UA-MT-master/model/UAMT_unlabel8/UAMTmulti/my_best_model.pth"
